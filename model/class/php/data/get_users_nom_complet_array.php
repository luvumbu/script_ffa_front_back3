...
include("liste_epreuves_arr.php"); 
...
$x= intval($get_users_naissance_array_2) ; 
...
?>
    ...
    //  echo array_search( $apple->list_row[$u], $arr)." : ! " ;
      ...
      switch (array_search( $apple->list_row[$u], $arr)) {
        case "0":
          echo  $perf_list[boucle($perf_cotation,$apple->list_row[$u-19])] ; 
          break;
          case "1":
            echo  $perf_list[boucle($perf_cotation2,$apple->list_row[$u-19])] ; 
            break;
            case "2":
            case "7":
              echo  $perf_list[boucle($perf_cotation3,$apple->list_row[$u-19])] ; 
              break;
              case "3":
              case "8":
                echo  $perf_list[boucle($perf_cotation4,$apple->list_row[$u-19])] ; 
                break;
                case "4":
                  echo  $perf_list[boucle($perf_cotation5,$apple->list_row[$u-19])] ; 
                  break;

                  case "5":
                    echo  $perf_list[boucle($perf_cotation6,$apple->list_row[$u-19])] ; 
                    break;
                    case "6":
                    case "16":
                      echo  $perf_list[boucle($perf_cotation7,$apple->list_row[$u-19])] ; 
                      break;
                      case "9":
                        echo  $perf_list[boucle($perf_cotation8,$apple->list_row[$u-19])] ; 
                        break;


                        case "10":
                        case "11":
                          echo  $perf_list[boucle($perf_cotation9,$apple->list_row[$u-19])] ; 
                        ...
                        $replace =     str_replace("m",".",$apple->list_row[$u-19]);
                          //  echo  $perf_list[boucle2($perf_cotation10,$replace)] ; 
                         ...
                         echo  $perf_list[boucle2($perf_cotation10,$replace)]; 
                            ...
                            case "14":
                              ...
                              $replace =     str_replace("m",".",$apple->list_row[$u-19]);
                               ...
                               echo  $perf_list[boucle2($perf_cotation11,$replace)]; 
                                  ...
                                  case "15":
                                    ...
                                    $replace =     str_replace("m",".",$apple->list_row[$u-19]);
                                     ...
                                     echo  $perf_list[boucle2($perf_cotation12,$replace)]; 
                                        ...
                                        case "17":
                                          ...
                                          $replace =     str_replace("m",".",$apple->list_row[$u-19]);
                                           ...
                                           echo  $perf_list[boucle2($perf_cotation13,$replace)]; 
                                              ...
                                              case "18":
                                                ...
                                                $replace =     str_replace("m",".",$apple->list_row[$u-19]);
                                                  ...
                                                  $div_perf = $perf_list[boucle2($perf_cotation14,$replace)] ; 
                                                 echo  $div_perf ; 
