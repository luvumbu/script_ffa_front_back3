...
function redirection_dowload_img(){
    
    
    
    var ok = new Information("../class/php/php_update/redirection_dowload_img_mysql.php"); // création de la classe 
